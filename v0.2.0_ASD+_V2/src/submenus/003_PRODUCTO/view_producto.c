...
#define UI_VID_REG_UP				11
#define UI_VID_REG_DOWN				12

static void producto_main_draw(void)
{
    ...
    EVE_color_a(255);
    EVE_color_rgb(BLACK);
    EVE_cmd_text_bold(title_x, title_y, PRODUCT_FONT_SIZE, EVE_OPT_FLAT, "Cambiar producto");
    ...
    ui_subm_draw_side_buttons(xR0, yR0, BTN, BTN, 10, side, 4);
}

static void producto_main_on_released(uint16_t id)
{
    switch (id)
    {
...
const UiView VIEW_PRODUCTO =
{
    .id = 79,
    .on_enter = 0,
    .on_exit = 0,
    .update = 0,
    .draw = producto_main_draw,
    .on_released = producto_main_on_released
};
