...
static void registro_expreg_draw(void)
{
    ...
    // ---- Texto placeholder ----
    EVE_color_rgb(BLACK);
    EVE_cmd_text(title_x + 150, title_y + 150, PRODUCT_FONT_SIZE, EVE_OPT_FLAT, "¿ Exportar registro ?");
...
static void registro_expreg_on_released(uint16_t id)
{
    switch (id)
    {
...
const UiView VIEW_REGISTRO_EXPREG =
{
    .id = 78,
    .on_enter = 0,
    .on_exit = 0,
    .update = 0,
    .draw = registro_expreg_draw,
    .on_released = registro_expreg_on_released
};
