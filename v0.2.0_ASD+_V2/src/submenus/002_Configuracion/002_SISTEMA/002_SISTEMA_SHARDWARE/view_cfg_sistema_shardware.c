...
static void opciones_sistema_admusers_draw(void)
{
    ...
    {
        { UI_VID_OPT_SIS_SHARDWARE_ES, 				"E/S"     			, MEM_ICON_ENTRADASYS  },
        { UI_VID_OPT_SIS_SHARDWARE_UC,  			"UC"      			, MEM_ICON_UC          },
        { UI_VID_OPT_SIS_SHARDWARE_VERSIONES,    	"Versiones" 		, MEM_ICON_VERSIONES   },
        { UI_VID_OPT_SIS_SHARDWARE_DEPURAR,   		"Depurar"           , MEM_ICON_DEBUG       },
    };
...
static void opciones_sistema_admusers_on_released(uint16_t id)
{
    switch (id)
    {
        ...
        case UI_VID_OPT_SIS_SHARDWARE_ES:
        	 ui_view_push(&VIEW_OPCIONES_SISTEMA_SHARDWARE_ES);
        	 break;

        case UI_VID_OPT_SIS_SHARDWARE_UC:
        	 ui_view_push(&VIEW_OPCIONES_SISTEMA_SHARDWARE_UC);
        	 break;

        case UI_VID_OPT_SIS_SHARDWARE_VERSIONES:
        	 ui_view_push(&VIEW_OPCIONES_SISTEMA_SHARDWARE_VERSIONES);
        	 break;

        case UI_VID_OPT_SIS_SHARDWARE_DEPURAR:
        	 ui_view_push(&VIEW_OPCIONES_SISTEMA_SHARDWARE_DEPURAR);
        	 break;
...
const UiView VIEW_OPCIONES_SISTEMA_SHARDWARE =
{
    .id = 32,
    .on_enter = 0,
    .on_exit = 0,
