/*
 * view_sistema_interfaces_servidor.c
 *
...
static void opciones_producto_interfaces_servidor_draw(void)
{
    ...
    EVE_color_a(255);
    EVE_color_rgb(BLACK);
    EVE_cmd_text_bold(title_x, title_y, PRODUCT_FONT_SIZE, EVE_OPT_FLAT, "Servidor");
...
static void opciones_producto_interfaces_servidor_on_released(uint16_t id)
{
    switch (id)
    {
...
const UiView VIEW_OPCIONES_SISTEMA_INTERFACES_SERVIDOR =
{
    .id = 91,
    .on_enter = 0,
    .on_exit = 0,
    .update = 0,
    .draw = opciones_producto_interfaces_servidor_draw,
    .on_released = opciones_producto_interfaces_servidor_on_released
};
