/*
 * view_cfg_sistema_admusers_ajustes.c
 *
...
static void opciones_sistena_admusers_ajustes_draw(void)
{
    ...
    EVE_color_a(255);
    EVE_color_rgb(BLACK);
    EVE_cmd_text_bold(title_x, title_y, PRODUCT_FONT_SIZE, EVE_OPT_FLAT, "Ajustes de usuario");
...
static void opciones_sistema_admusers_ajustes_on_released(uint16_t id)
{
    switch (id)
    {
...
const UiView VIEW_OPCIONES_SISTEMA_ADMINUSERS_AJUSTES =
{
    .id = 30,
    .on_enter = 0,
    .on_exit = 0,
    .update = 0,
    .draw = opciones_sistena_admusers_ajustes_draw,
    .on_released = opciones_sistema_admusers_ajustes_on_released
};
