/*
 * view_sistema_estadisticas_msignal.c
 *
...
static void opciones_sistema_estadisticas_msignal_draw(void)
{
    ...
    EVE_color_a(255);
    EVE_color_rgb(BLACK);
    EVE_cmd_text_bold(title_x, title_y, PRODUCT_FONT_SIZE, EVE_OPT_FLAT, "Metal signal");
...
static void opciones_sistema_estadisticas_msignal_on_released(uint16_t id)
{
    switch (id)
    {
...
const UiView VIEW_OPCIONES_SISTEMA_ESTADISTICAS_MSIGNAL =
{
    .id = 39,
    .on_enter = 0,
    .on_exit = 0,
    .update = 0,
    .draw = opciones_sistema_estadisticas_msignal_draw,
    .on_released = opciones_sistema_estadisticas_msignal_on_released
};
