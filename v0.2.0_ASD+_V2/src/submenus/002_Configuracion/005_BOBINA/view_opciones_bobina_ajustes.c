/*
 * view_opciones_bobina_ajustes.c
 *
...
static void opciones_bobina_ajustes_draw(void)
{
...
static void opciones_bobina_ajustes_on_released(uint16_t id)
{
    switch (id)
    {
...
const UiView VIEW_OPCIONES_BOBINA_AJUSTES =
{
    .id = 68,
    .on_enter = 0,
    .on_exit = 0,
    .update = 0,
    .draw = opciones_bobina_ajustes_draw,
    .on_released = opciones_bobina_ajustes_on_released
};
