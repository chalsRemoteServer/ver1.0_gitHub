...
static void opciones_bobina_draw(void)
{
    ...
    {
        { UI_VID_OPT_BOBINA_AJUSTES, 	"Ajustes"    		   , MEM_ICON_AJUSTES},
        { UI_VID_OPT_BOBINA_DFREC,  	"Desv. frecuencia"     , MEM_ICON_DESVFREC  },
    };
    ...
    ui_subm_draw_primary_grid2x3("Bobina", title_x, title_y, PRODUCT_FONT_SIZE, items, nItems, cards, drawCount,
        26,   // button_font
        28,   // label_font
...
static void opciones_bobina_on_released(uint16_t id)
{
    switch (id)
    {
        ...
        case UI_VID_OPT_BOBINA_AJUSTES:
             ui_view_push(&VIEW_OPCIONES_BOBINA_AJUSTES);
             break;

        case UI_VID_OPT_BOBINA_DFREC:
             ui_view_push(&VIEW_OPCIONES_BOBINA_DFREC);
             break;
...
const UiView VIEW_OPCIONES_BOBINA =
{
    .id = 67,
    .on_enter = 0,
    .on_exit = 0,
    .update = 0,
    .draw = opciones_bobina_draw,
    .on_released = opciones_bobina_on_released
};
