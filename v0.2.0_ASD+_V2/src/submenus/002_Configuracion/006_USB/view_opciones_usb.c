...
static void opciones_usb_draw(void)
{
    ...
    {
        { UI_VID_OPT_USB_EXPREG, 		"Exp. Registro"    	, MEM_ICON_EXPREGISTRO},
        { UI_VID_OPT_USB_EXP,  			"Exportar"     		, MEM_ICON_EXPORTAR  },
        { UI_VID_OPT_USB_IMPORT,    	"Importar" 			, MEM_ICON_IMPORTAR   },
        { UI_VID_OPT_USB_IMPORT, 		"Login2Go"    		, MEM_ICON_LOGIN2GO   },
    };
    ...
    ui_subm_draw_primary_grid2x3("USB", title_x, title_y, PRODUCT_FONT_SIZE, items, nItems, cards, drawCount,
        26,   // button_font
        28,   // label_font
...
static void opciones_usb_on_released(uint16_t id)
{
    switch (id)
    {
        ...
        case UI_VID_OPT_USB_EXPREG:
             ui_view_push(&VIEW_OPCIONES_USB_EXPREG);
             break;

        case UI_VID_OPT_USB_EXP:
             ui_view_push(&VIEW_OPCIONES_USB_EXPORTAR);
             break;

        case UI_VID_OPT_USB_IMPORT:
        	 ui_view_push(&VIEW_OPCIONES_USB_IMPORTAR);
        	 break;

        case UI_VID_OPT_USB_LOGIN2GO:
        	 ui_view_push(&VIEW_OPCIONES_USB_LOGIN2GO);
        	 break;
...
const UiView VIEW_OPCIONES_USB =
{
    .id = 70,
    .on_enter = 0,
    .on_exit = 0,
    .update = 0,
    .draw = opciones_usb_draw,
    .on_released = opciones_usb_on_released
};
