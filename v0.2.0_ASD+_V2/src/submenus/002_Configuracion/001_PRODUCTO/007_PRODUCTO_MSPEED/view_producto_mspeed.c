...
static void opciones_producto_mspeed_draw(void)
{
    ...
    {
        { UI_VID_OPT_PROD_MSPEED_INFO,       "Informacion",   	MEM_ICON_INFO},
        { UI_VID_OPT_PROD_MSPEED_MEDIR,  	 "Medicion", 		MEM_ICON_MSPEED },
        { UI_VID_OPT_PROD_MSPEED_CALC,    	 "Calculo", 	  	MEM_ICON_CALCULA},
        { UI_VID_OPT_PROD_MSPEED_AJUSTES,    "Ajustes",     	MEM_ICON_AJUSTES},
    };
    ...
    ui_subm_draw_primary_grid2x3("Velocidad de metal", title_x, title_y, PRODUCT_FONT_SIZE, items, nItems, cards, drawCount,
        26,   // button_font
        28,   // label_font
...
static void opciones_producto_mspeed_on_released(uint16_t id)
{
    switch (id)
    {
        ...
        case UI_VID_OPT_PROD_MSPEED_INFO:
        	 ui_view_push(&VIEW_OPCIONES_PRODUCTO_MSPEED_INFO);
        	 break;

        case UI_VID_OPT_PROD_MSPEED_MEDIR:
        	 ui_view_push(&VIEW_OPCIONES_PRODUCTO_MSPEED_MEDIC);
        	 break;

        case UI_VID_OPT_PROD_MSPEED_CALC:
        	 ui_view_push(&VIEW_OPCIONES_PRODUCTO_MSPEED_CALCULA);
             break;
        case UI_VID_OPT_PROD_MSPEED_AJUSTES:
        	 ui_view_push(&VIEW_OPCIONES_PRODUCTO_MSPEED_AJUSTES);
        	 break;
...
const UiView VIEW_OPCIONES_PRODUCTO_MSPEED =
{
    .id = 81,
    .on_enter = 0,
    .on_exit = 0,
    .update = 0,
    .draw = opciones_producto_mspeed_draw,
    .on_released = opciones_producto_mspeed_on_released
};
