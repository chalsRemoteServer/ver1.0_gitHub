/*
 * view_producto_mspeed_ajustes.c
 *
...
static void opciones_producto_mspeed_ajustes_draw(void)
{
...
static void opciones_producto_mspeed_ajustes_on_released(uint16_t id)
{
    switch (id)
    {
...
const UiView VIEW_OPCIONES_PRODUCTO_MSPEED_AJUSTES =
{
    .id = 85,
    .on_enter = 0,
    .on_exit = 0,
    .update = 0,
    .draw = opciones_producto_mspeed_ajustes_draw,
    .on_released = opciones_producto_mspeed_ajustes_on_released
};
