...
static void opciones_producto_salidas_tproductos_draw(void)
{
...
static void opciones_producto_salidas_tproductos_on_released(uint16_t id)
{
    switch (id)
    {
...
const UiView VIEW_OPCIONES_PRODUCTO_SALIDAS_TPRODUCTOS =
{
    .id = 21,
    .on_enter = 0,
    .on_exit = 0,
    .update = 0,
    .draw = opciones_producto_salidas_tproductos_draw,
    .on_released = opciones_producto_salidas_tproductos_on_released
};
