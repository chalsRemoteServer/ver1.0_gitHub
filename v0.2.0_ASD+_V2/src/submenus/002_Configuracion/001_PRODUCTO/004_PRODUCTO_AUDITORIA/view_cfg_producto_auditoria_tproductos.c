...
static void opciones_producto_auditoria_tproductos_draw(void)
{
    ...
    EVE_color_a(255);
    EVE_color_rgb(BLACK);
    EVE_cmd_text_bold(title_x, title_y, PRODUCT_FONT_SIZE, EVE_OPT_FLAT, "Aplicar a todos los productos");
...
static void opciones_producto_auditoria_tproductos_on_released(uint16_t id)
{
    switch (id)
    {
...
const UiView VIEW_OPCIONES_PRODUCTO_AUDITORIA_TPRODUCTOS =
{
    .id = 17,
    .on_enter = 0,
    .on_exit = 0,
    .update = 0,
    .draw = opciones_producto_auditoria_tproductos_draw,
    .on_released = opciones_producto_auditoria_tproductos_on_released
};
