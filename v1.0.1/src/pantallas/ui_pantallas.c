...
extern const UiScreen g_screen_2;     // pantalla contadores
extern const UiScreen g_screen_3;     // pantalla contadores
extern const UiScreen g_screen_4;     // pantalla contadores
