/*
 * view_opciones_entradas_digital.c
 *
...
static void opciones_entradas_digital_draw(void)
{
    ...
    EVE_color_a(255);
    EVE_color_rgb(BLACK);
    EVE_cmd_text_bold(title_x, title_y, PRODUCT_FONT_SIZE, EVE_OPT_FLAT, "Digital");
...
static void opciones_entradas_digital_on_released(uint16_t id)
{
    switch (id)
    {
...
const UiView VIEW_OPCIONES_ENTRADAS_DIGITAL =
{
    .id = 61,
    .on_enter = 0,
    .on_exit = 0,
    .update = 0,
    .draw = opciones_entradas_digital_draw,
    .on_released = opciones_entradas_digital_on_released
};
