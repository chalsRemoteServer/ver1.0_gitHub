/*
 * view_opciones_perifericos_superv.c
 *
...
static void opciones_perifericos_supervision_draw(void)
{
    ...
    {
        { UI_VID_OPT_SUP_RECHAZO, 			"Rechazo"     				, MEM_ICON_RECHAZO  		},
        { UI_VID_OPT_SUP_SENSAIRE,  		"Sensor de aire"      		, MEM_ICON_SENSORAIRE    	},
        { UI_VID_OPT_SUP_CONTLLENO,    		"Contenedor lleno" 			, MEM_ICON_CONTENEDOR 		},
    };
    ...
    ui_subm_draw_primary_grid2x3("Supervision", title_x, title_y, PRODUCT_FONT_SIZE, items, nItems, cards, drawCount,
        26,   // button_font
        28,   // label_font
...
static void opciones_perifericos_supervision_on_released(uint16_t id)
{
    switch (id)
    {
        ...
        case UI_VID_OPT_SUP_RECHAZO:
        	 ui_view_push(&VIEW_OPCIONES_PERIFERICOS_SUP_RECHAZO);
        	 break;

        case UI_VID_OPT_SUP_SENSAIRE:
        	 ui_view_push(&VIEW_OPCIONES_PERIFERICOS_SUP_SENAIRE);
        	 break;

        case UI_VID_OPT_SUP_CONTLLENO:
        	 ui_view_push(&VIEW_OPCIONES_PERIFERICOS_SUP_CONTLLENO);
        	 break;
...
const UiView VIEW_OPCIONES_PERIFERICOS_SUPERV =
{
    .id = 53,
    .on_enter = 0,
    .on_exit = 0,
    .update = 0,
    .draw = opciones_perifericos_supervision_draw,
    .on_released = opciones_perifericos_supervision_on_released
};
