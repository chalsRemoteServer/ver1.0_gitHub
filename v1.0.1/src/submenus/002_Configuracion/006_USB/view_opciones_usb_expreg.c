...
static void opciones_usb_expreg_draw(void)
{
    ...
    EVE_color_a(255);
    EVE_color_rgb(BLACK);
    EVE_cmd_text_bold(title_x, title_y, PRODUCT_FONT_SIZE, EVE_OPT_FLAT, "Exportar Registro");
...
static void opciones_usb_expreg_on_released(uint16_t id)
{
    switch (id)
    {
...
const UiView VIEW_OPCIONES_USB_EXPREG =
{
    .id = 71,
    .on_enter = 0,
    .on_exit = 0,
    .update = 0,
    .draw = opciones_usb_expreg_draw,
    .on_released = opciones_usb_expreg_on_released
};
