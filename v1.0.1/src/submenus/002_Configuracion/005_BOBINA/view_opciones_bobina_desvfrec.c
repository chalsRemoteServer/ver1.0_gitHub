/*
 * view_opciones_bobina_desvfrec.c
 *
...
static void opciones_bobina_desvfrec_draw(void)
{
    ...
    EVE_color_a(255);
    EVE_color_rgb(BLACK);
    EVE_cmd_text_bold(title_x, title_y, PRODUCT_FONT_SIZE, EVE_OPT_FLAT, "Desv. frecuencia");
...
static void opciones_bobina_desvfrec_on_released(uint16_t id)
{
    switch (id)
    {
...
const UiView VIEW_OPCIONES_BOBINA_DFREC =
{
    .id = 69,
    .on_enter = 0,
    .on_exit = 0,
    .update = 0,
    .draw = opciones_bobina_desvfrec_draw,
    .on_released = opciones_bobina_desvfrec_on_released
};
