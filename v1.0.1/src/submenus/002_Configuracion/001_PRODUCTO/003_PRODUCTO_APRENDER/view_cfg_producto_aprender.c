...
static void opciones_producto_aprender_draw(void)
{
    ...
    {
        { UI_VID_OPT_PROD_APRENDER_APRAPIDO,           "Aprend. rapido"},
        { UI_VID_OPT_PROD_APRENDER_APRESULTADOS,  	   "Resultados aprendizaje" },
    };
    ...
    ui_subm_draw_primary_grid2x3("Aprender", title_x, title_y, PRODUCT_FONT_SIZE, items, nItems, cards, drawCount,
        26,   // button_font
        28,   // label_font
...
static void opciones_producto_aprender_on_released(uint16_t id)
{
    switch (id)
    {
        ...
        case UI_VID_OPT_PROD_APRENDER_APRAPIDO:
        	ui_view_push(&VIEW_CFG_PROD_APRENDER_APRAPIDO);
        	break;

        case UI_VID_OPT_PROD_APRENDER_APRESULTADOS:
        	ui_view_push(&VIEW_CFG_PROD_APRENDER_APRESULTADOS);
        	break;
...
const UiView VIEW_OPCIONES_PRODUCTO_APRENDER =
{
    .id = 13,
    .on_enter = 0,
    .on_exit = 0,
    .update = 0,
    .draw = opciones_producto_aprender_draw,
    .on_released = opciones_producto_aprender_on_released
};
