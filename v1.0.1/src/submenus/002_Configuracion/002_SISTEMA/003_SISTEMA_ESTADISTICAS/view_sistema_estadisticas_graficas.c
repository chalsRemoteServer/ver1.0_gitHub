/*
 * view_sistema_estadisticas_graficas.c
 *
...
static void opciones_sistema_estadisticas_graficas_draw(void)
{
    ...
    EVE_color_a(255);
    EVE_color_rgb(BLACK);
    EVE_cmd_text_bold(title_x, title_y, PRODUCT_FONT_SIZE, EVE_OPT_FLAT, "Disp.");
...
static void opciones_sistema_estadisticas_graficas_on_released(uint16_t id)
{
    switch (id)
    {
...
const UiView VIEW_OPCIONES_SISTEMA_ESTADISTICAS_GRAF =
{
    .id = 40,
    .on_enter = 0,
    .on_exit = 0,
    .update = 0,
    .draw = opciones_sistema_estadisticas_graficas_draw,
    .on_released = opciones_sistema_estadisticas_graficas_on_released
};
