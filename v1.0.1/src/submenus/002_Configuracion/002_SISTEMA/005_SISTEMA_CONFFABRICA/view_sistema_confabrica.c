...
static void opciones_sistema_estadisticas_draw(void)
{
    ...
    {
        { UI_VID_OPT_SIS_CONFABRICA_GUARDARC, 				"Guardar config."     	,  MEM_ICON_GUARDCONFIG },
        { UI_VID_OPT_SIS_CONFABRICA_RESTAURARC,  			"Restaurar config."      , MEM_ICON_RESTCONFIG  },
    ...
    ui_subm_draw_primary_grid2x3("Conf. de fabrica", title_x, title_y, PRODUCT_FONT_SIZE, items, nItems, cards, drawCount,
        26,   // button_font
        28,   // label_font
...
static void opciones_sistema_estadisticas_on_released(uint16_t id)
{
    switch (id)
    {
        ...
        case UI_VID_OPT_SIS_CONFABRICA_GUARDARC:
        	 ui_view_push(&VIEW_OPCIONES_SISTEMA_CONFABRICA_GCONFIG);
        	 break;

        case UI_VID_OPT_SIS_CONFABRICA_RESTAURARC:
        	 ui_view_push(&VIEW_OPCIONES_SISTEMA_CONFABRICA_RCONFIG);
        	 break;
...
const UiView VIEW_OPCIONES_SISTEMA_CONFFABRICA =
{
    .id = 43,
    .on_enter = 0,
    .on_exit = 0,
