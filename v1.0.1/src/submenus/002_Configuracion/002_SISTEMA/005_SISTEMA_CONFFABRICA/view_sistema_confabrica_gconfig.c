/*
 * view_sistema_confabrica_gconfig.c
 *
...
static void opciones_sistema_confabrica_gconfig_draw(void)
{
...
static void opciones_sistema_confabrica_gconfig_on_released(uint16_t id)
{
    switch (id)
    {
...
const UiView VIEW_OPCIONES_SISTEMA_CONFABRICA_GCONFIG =
{
    .id = 44,
    .on_enter = 0,
    .on_exit = 0,
    .update = 0,
    .draw = opciones_sistema_confabrica_gconfig_draw,
    .on_released = opciones_sistema_confabrica_gconfig_on_released
};
