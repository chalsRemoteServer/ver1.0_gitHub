...
static void opciones_sistena_admusers_crear_draw(void)
{
    ...
    EVE_color_a(255);
    EVE_color_rgb(BLACK);
    EVE_cmd_text_bold(title_x, title_y, PRODUCT_FONT_SIZE, EVE_OPT_FLAT, "Crear usuario");
...
const UiView VIEW_OPCIONES_SISTEMA_ADMINUSERS_CREAR =
{
    ...
    .on_exit = 0,
    .update = 0,
    .draw = opciones_sistena_admusers_crear_draw,
