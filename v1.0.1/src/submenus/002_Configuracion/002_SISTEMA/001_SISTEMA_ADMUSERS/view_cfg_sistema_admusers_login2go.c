/*
 * view_cfg_sistema_admusers_login2go.c
 *
...
static void opciones_sistena_admusers_login2go_draw(void)
{
    ...
    EVE_color_a(255);
    EVE_color_rgb(BLACK);
    EVE_cmd_text_bold(title_x, title_y, PRODUCT_FONT_SIZE, EVE_OPT_FLAT, "Crear Login2Go");
...
static void opciones_sistema_admusers_login2go_on_released(uint16_t id)
{
    switch (id)
    {
...
const UiView VIEW_OPCIONES_SISTEMA_ADMINUSERS_LOGIN2GO =
{
    .id = 31,
    .on_enter = 0,
    .on_exit = 0,
    .update = 0,
    .draw = opciones_sistena_admusers_login2go_draw,
    .on_released = opciones_sistema_admusers_login2go_on_released
};
