...
static void aprender_draw(void)
{
    ...
    {
        { UI_VID_APR_FAST,    "Aprend. rapido", MEM_ICON_HOME},
        { UI_VID_APR_RESULTS, "Resultados"    , MEM_ICON_HOME},
    };
    ...
    ui_subm_draw_primary_grid2x3("Aprender", title_x, title_y, PRODUCT_FONT_SIZE, items, nItems, cards, drawCount, 26, 28, 8);
