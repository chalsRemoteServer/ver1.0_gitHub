/*
 * view_sistema_licencia_importar.c
 *
...
static void opciones_sistema_licencia_importar_draw(void)
{
    ...
    EVE_color_a(255);
    EVE_color_rgb(BLACK);
    EVE_cmd_text_bold(title_x, title_y, PRODUCT_FONT_SIZE, EVE_OPT_FLAT, "Importar informacion");

    // ---- Texto placeholder ----
    EVE_color_rgb(BLACK);
    EVE_cmd_text(title_x + 150, title_y + 150, PRODUCT_FONT_SIZE, EVE_OPT_FLAT, "Importar a USB");
...
static void opciones_sistema_licencia_importar_on_released(uint16_t id)
{
    switch (id)
    {
...
const UiView VIEW_OPCIONES_SISTEMA_LICENCIA_IMPORTAR =
{
    .id = 49,
    .on_enter = 0,
    .on_exit = 0,
    .update = 0,
    .draw = opciones_sistema_licencia_importar_draw,
    .on_released = opciones_sistema_licencia_importar_on_released
};
