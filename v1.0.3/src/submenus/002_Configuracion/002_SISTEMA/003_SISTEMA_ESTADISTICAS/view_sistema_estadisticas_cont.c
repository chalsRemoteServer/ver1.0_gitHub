/*
 * view_sistema_estadisticas_cont.c
 *
...
static void opciones_sistema_estadisticas_cont_draw(void)
{
...
static void opciones_sistema_estadisticas_cont_on_released(uint16_t id)
{
    switch (id)
    {
...
const UiView VIEW_OPCIONES_SISTEMA_ESTADISTICAS_CONT =
{
    .id = 38,
    .on_enter = 0,
    .on_exit = 0,
    .update = 0,
    .draw = opciones_sistema_estadisticas_cont_draw,
    .on_released = opciones_sistema_estadisticas_cont_on_released
};
