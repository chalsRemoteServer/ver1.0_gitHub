/*
 * view_sistema_estadisticas_ajustes.c
 *
...
static void opciones_sistema_estadisticas_ajustes_draw(void)
{
...
static void opciones_sistema_estadisticas_ajustes_on_released(uint16_t id)
{
    switch (id)
    {
...
const UiView VIEW_OPCIONES_SISTEMA_ESTADISTICAS_AJUSTES =
{
    .id = 41,
    .on_enter = 0,
    .on_exit = 0,
    .update = 0,
    .draw = opciones_sistema_estadisticas_ajustes_draw,
    .on_released = opciones_sistema_estadisticas_ajustes_on_released
};
