...
static void opciones_sistema_estadisticas_draw(void)
{
    ...
    {
        { UI_VID_OPT_SIS_ESTADISTICAS_CONT, 			"Contadores"     	, MEM_ICON_CONTADORES  },
        { UI_VID_OPT_SIS_ESTADISTICAS_SMETAL,  			"Metal signal"      , MEM_ICON_METALSIGNAL          },
        { UI_VID_OPT_SIS_ESTADISTICAS_GRAFICAS,    		"Graficas" 			, MEM_ICON_DISPLAYS   },
        { UI_VID_OPT_SIS_ESTADISTICAS_AJUSTES,   		"Ajustes"           , MEM_ICON_AJUSTES       },
    };
    ...
    ui_subm_draw_primary_grid2x3("Estadisticas", title_x, title_y, PRODUCT_FONT_SIZE, items, nItems, cards, drawCount,
        26,   // button_font
        28,   // label_font
...
static void opciones_sistema_estadisticas_on_released(uint16_t id)
{
    switch (id)
    {
        ...
        case UI_VID_OPT_SIS_ESTADISTICAS_CONT:
        	 ui_view_push(&VIEW_OPCIONES_SISTEMA_ESTADISTICAS_CONT);
        	 break;

        case UI_VID_OPT_SIS_ESTADISTICAS_SMETAL:
        	 ui_view_push(&VIEW_OPCIONES_SISTEMA_ESTADISTICAS_MSIGNAL);
        	 break;

        case UI_VID_OPT_SIS_ESTADISTICAS_GRAFICAS:
        	 ui_view_push(&VIEW_OPCIONES_SISTEMA_ESTADISTICAS_GRAF);
        	 break;

        case UI_VID_OPT_SIS_ESTADISTICAS_AJUSTES:
        	 ui_view_push(&VIEW_OPCIONES_SISTEMA_ESTADISTICAS_AJUSTES);
        	 break;
...
const UiView VIEW_OPCIONES_SISTEMA_ESTADISTICAS =
{
    .id = 37,
    .on_enter = 0,
    .on_exit = 0,
    .update = 0,
    .draw = opciones_sistema_estadisticas_draw,
    .on_released = opciones_sistema_estadisticas_on_released
};
