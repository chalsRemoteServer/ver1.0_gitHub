/*
 * view_cfg_sistema_shardware_ES.c
 *
...
static void opciones_sistema_shardware_es_draw(void)
{
    ...
    EVE_color_a(255);
    EVE_color_rgb(BLACK);
    EVE_cmd_text_bold(title_x, title_y, PRODUCT_FONT_SIZE, EVE_OPT_FLAT, "Entradas y salidas");
...
static void opciones_sistema_shardware_es_on_released(uint16_t id)
{
    switch (id)
    {
...
const UiView VIEW_OPCIONES_SISTEMA_SHARDWARE_ES =
{
    .id = 33,
    .on_enter = 0,
    .on_exit = 0,
    .update = 0,
    .draw = opciones_sistema_shardware_es_draw,
    .on_released = opciones_sistema_shardware_es_on_released
};
