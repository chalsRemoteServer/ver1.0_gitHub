...
static void opciones_producto_salidas_momr_draw(void)
{
...
static void opciones_producto_salidas_momr_on_released(uint16_t id)
{
    switch (id)
    {
...
const UiView VIEW_OPCIONES_PRODUCTO_SALIDAS_MOMR =
{
    .id = 22,
    .on_enter = 0,
    .on_exit = 0,
    .update = 0,
    .draw = opciones_producto_salidas_momr_draw,
    .on_released = opciones_producto_salidas_momr_on_released
};
