/*
 * view_cfg_producto_aprender_aprapido.c
 *
...
#define UI_VID_PROD_APRENDFAST_CANCEL      10
#define UI_VID_PROD_APRENDFAST_ACCEPT	   11
#define UI_VID_PROD_APRENDFAST_BACK        12

static void opciones_producto_aprender_aprapido_draw(void)
{
	const UiMainLayout* L = &UI_LAYOUT_MAIN;
		...
		{
				{ UI_VID_PROD_APRENDFAST_CANCEL, "X"                    },
				{ UI_VID_PROD_APRENDFAST_ACCEPT, "", MEM_ICON_INIMANUAL },
		};
...
static void opciones_producto_aprender_aprapido_on_released(uint16_t id)
{
    switch (id)
    {
        case UI_VID_PROD_APRENDFAST_CANCEL:
...
const UiView VIEW_CFG_PROD_APRENDER_APRAPIDO =
{
    .id = 14,
    .on_enter = 0,
    .on_exit = 0,
    .update = 0,
    .draw = opciones_producto_aprender_aprapido_draw,
    .on_released = opciones_producto_aprender_aprapido_on_released
};
