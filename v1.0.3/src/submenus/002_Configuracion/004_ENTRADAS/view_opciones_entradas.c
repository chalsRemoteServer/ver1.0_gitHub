...
static void opciones_entradas_draw(void)
{
    ...
    {
        { UI_VID_OPT_ENTRADAS_EXT, 			"Externo"    		, MEM_ICON_EXTERNO},
        { UI_VID_OPT_ENTRADAS_DIGITAL,  	"Digital"     		, MEM_ICON_DIGITAL  },
        { UI_VID_OPT_ENTRADAS_CONFIG,    	"Configurable" 		, MEM_ICON_CONFIGURABLE },
    };
    ...
    ui_subm_draw_primary_grid2x3("Entradas", title_x, title_y, PRODUCT_FONT_SIZE, items, nItems, cards, drawCount,
        26,   // button_font
        28,   // label_font
...
static void opciones_entradas_on_released(uint16_t id)
{
    switch (id)
    {
        ...
        case UI_VID_OPT_ENTRADAS_EXT:
             ui_view_push(&VIEW_OPCIONES_ENTRADAS_EXTERNO);
             break;

        case UI_VID_OPT_ENTRADAS_DIGITAL:
             ui_view_push(&VIEW_OPCIONES_ENTRADAS_DIGITAL);
             break;

        case UI_VID_OPT_ENTRADAS_CONFIG:
        	 ui_view_push(&VIEW_OPCIONES_ENTRADAS_CONFIGURABLE);
        	 break;
...
const UiView VIEW_OPCIONES_ENTRADAS =
{
    .id = 59,
    .on_enter = 0,
    .on_exit = 0,
    .update = 0,
    .draw = opciones_entradas_draw,
    .on_released = opciones_entradas_on_released
};
