/*
 * view_opciones_entradas_conf_ajustes.c
 *
...
static void opciones_entradas_config_ajustes_draw(void)
{
...
static void opciones_entradas_config_ajustes_on_released(uint16_t id)
{
    switch (id)
    {
...
const UiView VIEW_OPCIONES_ENTRADAS_CONFIG_AJUST =
{
    .id = 63,
    .on_enter = 0,
    .on_exit = 0,
    .update = 0,
    .draw = opciones_entradas_config_ajustes_draw,
    .on_released = opciones_entradas_config_ajustes_on_released
};
