/*
 * voew_opciones_entradas_conf_ent1.c
 *
...
static void opciones_entradas_config_ent1_draw(void)
{
    ...
    EVE_color_a(255);
    EVE_color_rgb(BLACK);
    EVE_cmd_text_bold(title_x, title_y, PRODUCT_FONT_SIZE, EVE_OPT_FLAT, "Entrada 1");
...
static void opciones_entradas_config_ent1_on_released(uint16_t id)
{
    switch (id)
    {
...
const UiView VIEW_OPCIONES_ENTRADAS_CONFIG_ENT1 =
{
    .id = 64,
    .on_enter = 0,
    .on_exit = 0,
    .update = 0,
    .draw = opciones_entradas_config_ent1_draw,
    .on_released = opciones_entradas_config_ent1_on_released
};
