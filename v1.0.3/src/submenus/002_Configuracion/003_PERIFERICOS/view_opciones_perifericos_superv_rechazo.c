/*
 * view_opciones_perifericos_superv_rechazo.c
 *
...
static void opciones_perifericos_supervision_rechazo_draw(void)
{
    ...
    EVE_color_a(255);
    EVE_color_rgb(BLACK);
    EVE_cmd_text_bold(title_x, title_y, PRODUCT_FONT_SIZE, EVE_OPT_FLAT, "Supervision rechazo");

    // ---- Texto placeholder ----
    EVE_color_rgb(BLACK);
    EVE_cmd_text(title_x + 150, title_y + 150, PRODUCT_FONT_SIZE, EVE_OPT_FLAT, "Configura rechazo");
...
static void opciones_perifericos_supervision_rechazo_on_released(uint16_t id)
{
    switch (id)
    {
...
const UiView VIEW_OPCIONES_PERIFERICOS_SUP_RECHAZO =
{
    .id = 54,
    .on_enter = 0,
    .on_exit = 0,
    .update = 0,
    .draw = opciones_perifericos_supervision_rechazo_draw,
    .on_released = opciones_perifericos_supervision_rechazo_on_released
};
