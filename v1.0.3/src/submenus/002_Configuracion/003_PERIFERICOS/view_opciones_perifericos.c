...
static void opciones_perifericos_draw(void)
{
    ...
    {
        { UI_VID_OPT_PER_OPCEXP, 		"Opc. Expulsion"     	, MEM_ICON_OPCEXP  			},
        { UI_VID_OPT_PER_SUPERV,  		"Supervision"      		, MEM_ICON_SUPERVISION    	},
        { UI_VID_OPT_PER_ADVERT,    	"Advertencia" 			, MEM_ICON_ADVERTENCIA 		},
        { UI_VID_OPT_PER_PRAUTO,   		"Prueba auto."          , MEM_ICON_PRUEBAAUTO    	},
    };
    ...
    ui_subm_draw_primary_grid2x3("Perifericos", title_x, title_y, PRODUCT_FONT_SIZE, items, nItems, cards, drawCount,
        26,   // button_font
        28,   // label_font
...
static void opciones_perifericos_on_released(uint16_t id)
{
    switch (id)
    {
        ...
        case UI_VID_OPT_PER_OPCEXP:
        	 ui_view_push(&VIEW_OPCIONES_PERIFERICOS_OPCEXP);
        	 break;

        case UI_VID_OPT_PER_SUPERV:
        	 ui_view_push(&VIEW_OPCIONES_PERIFERICOS_SUPERV);
        	 break;

        case UI_VID_OPT_PER_ADVERT:
        	 ui_view_push(&VIEW_OPCIONES_PERIFERICOS_ADVERTENCIA);
        	 break;

        case UI_VID_OPT_PER_PRAUTO:
        	 ui_view_push(&VIEW_OPCIONES_PERIFERICOS_AUTOTEST);
        	 break;
...
const UiView VIEW_OPCIONES_PERIFERICOS =
{
    .id = 51,
    .on_enter = 0,
    .on_exit = 0,
    .update = 0,
    .draw = opciones_perifericos_draw,
    .on_released = opciones_perifericos_on_released
};
