/*
 * view_opciones_perifericos_OpcExp.c
 *
...
static void opciones_perifericos_opcexp_draw(void)
{
...
static void opciones_perifericos_opcexp_on_released(uint16_t id)
{
    switch (id)
    {
...
const UiView VIEW_OPCIONES_PERIFERICOS_OPCEXP =
{
    .id = 52,
    .on_enter = 0,
    .on_exit = 0,
    .update = 0,
    .draw = opciones_perifericos_opcexp_draw,
    .on_released = opciones_perifericos_opcexp_on_released
};
