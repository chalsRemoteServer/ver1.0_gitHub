...
#define UI_VID_APREND_RAPREND_CANCEL	10
#define UI_VID_APREND_RAPREND_ACEPTA	11
#define UI_VID_APREND_RAPREND_FUP		12
#define UI_VID_APREND_RAPREND_FDOWN		13
...
static void aprender_results_draw(void)
{
	...
	{
			{ UI_VID_APREND_RAPREND_CANCEL, "X"                    	},
			{ UI_VID_APREND_RAPREND_ACEPTA, ""	, MEM_ICON_ACEPTAR 	},
			{ UI_VID_APREND_RAPREND_FUP, ""		, MEM_ICON_FARRIBA 	},
			{ UI_VID_APREND_RAPREND_FDOWN, ""	, MEM_ICON_FABAJO 	},
	};
...
static void aprender_results_on_released(uint16_t id)
{
    switch (id)
    {
        case UI_VID_APREND_RAPREND_CANCEL:
